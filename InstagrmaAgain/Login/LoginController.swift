...
class LoginController: UIViewController {
    ...
    @objc func handleTextInputChange() {
        //?? 의 의미는 첫번째벨류 ?? 두번째벨류 일때 첫번째 벨류가 nill 값이면 두번째 벨류를 받고, nill 이 아니면 첫번째벨류를 받는다.
    ...
    override func viewDidLoad() {
        ...
        logoContainerView.centerXAnchor.constraintEqualToSystemSpacingAfter(self.view.centerXAnchor, multiplier: 0).isActive = true
            logoContainerView.centerYAnchor.constraintEqualToSystemSpacingBelow(self.view.centerYAnchor, multiplier: 0).isActive = true
